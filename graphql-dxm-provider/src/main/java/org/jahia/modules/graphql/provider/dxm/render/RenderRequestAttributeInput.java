...
public class RenderRequestAttributeInput {
    ...
    public RenderRequestAttributeInput(@GraphQLName("name") @GraphQLNonNull @GraphQLDescription("The name of the request attribute")  String name,
                                       @GraphQLName("value") @GraphQLNonNull @GraphQLDescription("The value of the request attribute")  String value) {
        this.name = name;
        this.value = value;
    }
