...
public class GqlJcrMutation extends GqlJcrMutationSupport implements DXGraphQLFieldCompleter {
    ...
    /**
     *
     * @param pathOrId path of the file to zip
     * @param environment data fetching environment
     * @return always true
    ...
    public boolean zipFile(
            @GraphQLName("pathOrId") @GraphQLNonNull @GraphQLDescription("The path or id of the file node") String pathOrId,
            DataFetchingEnvironment environment
    ) throws DataFetchingException {
        zipFile(getNodeFromPathOrId(getSession(), pathOrId), getSession(), environment);
        return true;
    }
