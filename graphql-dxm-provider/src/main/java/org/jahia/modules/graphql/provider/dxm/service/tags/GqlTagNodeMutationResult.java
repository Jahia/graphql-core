...
@GraphQLName("TagNodeMutationResult")
@GraphQLDescription("The result of a single-node tag mutation")
public class GqlTagNodeMutationResult {
    private final String tag;
    private final String nodeId;
    private final List<GqlTagWorkspaceMutationResult> workspaceResults;

    public GqlTagNodeMutationResult(String tag, String nodeId, List<GqlTagWorkspaceMutationResult> workspaceResults) {
        this.tag = tag;
        this.nodeId = nodeId;
    ...
    @GraphQLField
    @GraphQLNonNull
    @GraphQLDescription("The impacted node identifier")
